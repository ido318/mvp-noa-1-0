...
**Date:** 2026-08-29
**Status:** All 6 phases shipped. Tokens + sidebar, today dashboard, calendar + appointment drawer + booking wizard, client + patient detail with a UI-only invoices backend, encounter workspace + prescriptions restyle, and tasks/lab/billing-list with three new real nav items — see [2026-08-29-figma-phase3-calendar-appointments-design.md](2026-08-29-figma-phase3-calendar-appointments-design.md), [2026-08-29-figma-phase4-client-patient-detail-design.md](2026-08-29-figma-phase4-client-patient-detail-design.md), [2026-08-29-figma-phase5-encounter-workspace-design.md](2026-08-29-figma-phase5-encounter-workspace-design.md), and [2026-08-29-figma-phase6-tasks-lab-billing-design.md](2026-08-29-figma-phase6-tasks-lab-billing-design.md). Every phase was verified in a real browser against local Supabase, not just typecheck/tests.
