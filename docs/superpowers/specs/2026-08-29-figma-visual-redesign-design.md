...
**Date:** 2026-08-29
**Status:** Phases 1-5 shipped (tokens + sidebar, today dashboard, calendar + appointment drawer + booking wizard, client + patient detail with a new UI-only invoices backend, encounter workspace + prescriptions restyle — see [2026-08-29-figma-phase3-calendar-appointments-design.md](2026-08-29-figma-phase3-calendar-appointments-design.md), [2026-08-29-figma-phase4-client-patient-detail-design.md](2026-08-29-figma-phase4-client-patient-detail-design.md), and [2026-08-29-figma-phase5-encounter-workspace-design.md](2026-08-29-figma-phase5-encounter-workspace-design.md)). Phase 6 remains.
