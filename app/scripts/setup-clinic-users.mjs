 ...
 *
 *   noa@voxly--ai.com     owner   — Dr. Noa, the vet who runs the day
 *   owner@voxly--ai.com   admin   — operator account, for agent tuning and triage
 *
...
const USERS = [
  {
    currentEmail: "noa@getavet.co.il",
    email: "noa@voxly--ai.com",
    role: "owner",
    fullName: "ד״ר נועה כבשני",
    password: process.env.NOA_PASSWORD,
    passwordVar: "NOA_PASSWORD",
  },
  {
    currentEmail: "idoamsalem100@gmail.com",
    email: "owner@voxly--ai.com",
    role: "admin",
    fullName: "עידו אמסלם",
