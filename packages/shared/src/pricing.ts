...
export type PriceListEntry = {
   ...
   *
   * Neutering is the case this exists for: 350 ₪ is a real number and Noa
...
/** Frozen wording. Do not change without Noa's approval. */
export const NO_QUOTABLE_PRICE_TEXT = 'המחיר יימסר על ידי ד"ר נועה';
